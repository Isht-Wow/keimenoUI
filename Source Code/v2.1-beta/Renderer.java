...
public class Renderer<T extends Renderer<T>> extends AudioManager<Renderer<T>> {

    /**
     * Constructs a new {@code Renderer} instance with the specified {@link CoreState} settings.
    ...
    public void playFrames(String folderPath, int maxWidth) {
        ...
        if (coreState.audioEnabled) {
            super.startPlaying(folderPath, folderPath + "Audio.wav", 0);
        }
