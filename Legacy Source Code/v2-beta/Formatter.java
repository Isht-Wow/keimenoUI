...
public class Formatter {
     ...
     * <ul>
     * <li>A top filler line using the current filler character and fill color.</li>
     * <li>A centered title line with the given {@code title} string, padded
     * according to the current width and alignment, and colored with the content color.</li>
     * <li>A bottom filler line identical to the top line.</li>
     * </ul>
     *
     * <p>
     * If {@code title} is {@code null}, it is treated as an empty string. The
     * method is chainable and returns the same {@code Formatter} instance.
     * </p>
     *
     * <p>
     * This method does <b>not</b> print the header immediately; it only appends it
     * to the internal buffer. Use the print method to output the content.
     * </p>
     *
