...
public class AsciiArt {
    ...
    /**
     * Applies the specified {@link CoreState} settings to this {@code AsciiArt} instance.
     ...
     *
     * @param coreState the {@code CoreState} object containing configuration settings
     */
     ...
     *
     * @param path     the file path to the image to be converted
     * @param maxWidth the maximum width in characters for the ASCII art output
     ...
     *
     * @param folderPath the path to the folder containing image frames for the animation
     * @param maxWidth   the maximum width in characters for each ASCII art frame
     */
    public void playFrames(String folderPath, int maxWidth) {
        ...
        if (coreState.audioEnabled) {
            ...
            audio.startPlaying(folderPath, folderPath + "Audio.wav");
        }
